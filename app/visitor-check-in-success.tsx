...
export default function VisitorCheckInSuccessScreen() {
      ...
      <SafeAreaView style={styles.container} edges={["top", "bottom"]}>
        <View style={styles.iconWrapper}>
          <View style={styles.shapeContainer}>
            <Svg width={165} height={167} viewBox="0 0 165 167" style={styles.shapeSvg}>
        ...
        <Text style={styles.title}>You&apos;re all checked in!</Text>
        <Text style={styles.subtitle}>
          Your visit has been registered. The resident has been notified and will be waiting for you.
        </Text>

        <View style={styles.warningBox}>
          <Feather name="alert-triangle" size={20} color="#B91C1C" style={{ marginRight: rs(10) }} />
          <Text style={styles.warningText}>
            Show this screen at the security desk to enter the building.
          </Text>
        </View>
